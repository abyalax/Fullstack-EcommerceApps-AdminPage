...
type BannnerFormValues = z.infer<typeof formSchema>

const BannerForm = ({ initialData }: BannerFormProps) => {
    ...
    const form = useForm<BannnerFormValues>({
    ...
    const onDelete = async () => {
        try {
            ...
            console.log(error)
            toast.error("Failed to delete banner, Check your connection")
            setLoading(false)
        } finally {
            setLoading(false)
            setOpen(false)
